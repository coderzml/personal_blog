![](../../../image/JQuery/fullpage.gif)

> 全屏滚动效果，原生js也很好实现，主要是用 mousewheel  鼠标滚轮滚动事件， 来判断上滚动还是下滚动，之后设置每次滚动的高度为屏幕的高度即可。但是，虽然效果简单，但是兼容性很差，要做很多兼容处理就比较麻烦
...
- 看不明白的话，结合案例一起看。站内搜索：**全屏滚动效果**

#### 案例：

![](../../../image/project/article11.png)

address:http://zmlong.usa3v.net/html/project/shoping/index.html